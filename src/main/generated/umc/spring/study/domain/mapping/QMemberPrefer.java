...
public class QMemberPrefer extends EntityPathBase<MemberPrefer> {
    ...
    public final umc.spring.study.domain.QFood_category foodCategory;
    ...
    public QMemberPrefer(Class<? extends MemberPrefer> type, PathMetadata metadata, PathInits inits) {
        ...
        this.foodCategory = inits.isInitialized("foodCategory") ? new umc.spring.study.domain.QFood_category(forProperty("foodCategory")) : null;
